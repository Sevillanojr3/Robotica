...
(cl:in-package mi_robot_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <HandData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HandData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mi_robot_pkg-msg:<HandData> is deprecated: use mi_robot_pkg-msg:HandData instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <HandData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mi_robot_pkg-msg:x-val is deprecated.  Use mi_robot_pkg-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <HandData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mi_robot_pkg-msg:y-val is deprecated.  Use mi_robot_pkg-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'is_open-val :lambda-list '(m))
(cl:defmethod is_open-val ((m <HandData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mi_robot_pkg-msg:is_open-val is deprecated.  Use mi_robot_pkg-msg:is_open instead.")
  (is_open m))
