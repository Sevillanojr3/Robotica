...
def order_publisher():
    ...
    while not rospy.is_shutdown():
        ...
        print("Ingrese el código de acción (1-4), o 'q' para salir:")
        input_str = input()
        if input_str.lower() == 'q':
            break
        try:
            action_code = int(input_str)
            if action_code < 1 or action_code > 4:
                print("Código de acción inválido. Ingrese un número entre 1 y 4.")
                continue
            msg = Int32()
            ...
            print("Entrada inválida. Ingrese un número entre 1 y 4.")
        rate.sleep()
